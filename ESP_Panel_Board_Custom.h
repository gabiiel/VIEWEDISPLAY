 ...
 */
    ...
    #define ESP_PANEL_LCD_RGB_BOUNCE_BUF_SIZE   (800*10)     // Bounce buffer size in bytes. This function is used to avoid screen drift.
...
#define ESP_PANEL_TOUCH_H_RES       (800)   // Typically set to the same value as the width of LCD
